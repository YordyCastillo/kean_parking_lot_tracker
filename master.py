...
# path references
fn = "/Users/Yordy/Desktop/senior capstone/test_img/keanparking1080.mov"  # 3
fn_yaml = "kean_02.yml"
fn_out = "kean_01.avi"
cascade_src = 'keanhaar3.xml'
...
while (cap.isOpened()):
    ...
    if ret == True:
        frame = cv2.resize(frame_initial, None, fx=.6, fy=.6)
    if ret == False:
        print("Video ended")
        break
        ...
        for ind, park in enumerate(parking_data):
            ...
            if status != parking_status[ind] and parking_buffer[ind] == None:
                ...
                if dict['classifier_used']:
                    classifier_result = run_classifier(roi_gray,id)
    ...
    if k == ord('q'):
        ...
        cap.set(cv2.CAP_PROP_POS_FRAMES, video_cur_frame + 100)  # jump 10 frames
